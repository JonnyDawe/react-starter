...
export const tooltipRecipe = appTwVariants({
  slots: {
    ...
    arrow: [
      'group-placement-top:-translate-y-[1px] group-placement-top:rotate-0',
      'group-placement-right:translate-x-[1px] group-placement-right:rotate-90',
      'group-placement-bottom:translate-y-[1px] group-placement-bottom:rotate-180',
      'group-placement-left:-translate-x-[1px] group-placement-left:-rotate-90',
    ],
